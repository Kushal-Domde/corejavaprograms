...
public class CRUDDemo 
{
	...
	public void createTable()
	{
		try
		{
			...
			stmt.executeUpdate("CREATE TABLE Book6( BookNAME VARCHAR(200),BookID VARCHAR(20),NOOFPAGES INT,AUTHORNAME VARCHAR(50))");
//			stmt.executeUpdate("CREATE TABLE Book4( Book4NAME VARCHAR(200),BookID SERIAL PRIMARY KEY,NOOFPAGES INT,AUTHORNAME VARCHAR(50))");
			stmt.close();	
			connect.close();
	...
	public void insert1Value()	
	{
		try
		{
			...
			String query=" INSERT INTO Book6(Bookname,Bookid,noofpages,authorname)"+" VALUES(?,?,?,?)";
			...
			stmt.close(); 
			connect.close();
			System.out.println(count.length+"Records inserted..... into Book6 ");                 
		}
		catch (Exception e) 
		{
			e.printStackTrace();
	...
	public void display() 
	{
		...
		try
		{
			...
			Singelton single=new Singelton();
			connect=single.getConnection();
			String query="Select*from Book6";
			PreparedStatement  pstmt= connect.prepareStatement(query);
